...
from mpvqc.gui.messageboxes import MessageBoxes, UnsavedChangesQuitResponse as MbResponse


class QuitUnsavedMessageBox:

    def __init__(self, app: App):
        self._parent = app.parent()
        self._response: Optional[MbResponse] = None

    def do_we_quit(self) -> bool:
        self._ensure_response()
        return self._response == MbResponse.QUIT
    ...
    def _we_ask(self):
        self._response = MessageBoxes.unsaved_changes_quit(self._parent)
