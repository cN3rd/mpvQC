...
from mpvqc.gui.messageboxes import MessageBoxes, UnsavedChangesCreateNewDocumentResponse as MbResponse


class NewDocumentMessageBox:
    ...
    def _we_ask(self):
        self._response = MessageBoxes.unsaved_changes_create_new_document(self._parent)
