...
from mpvqc.io.doc_exporter import DocumentRecipe, DocumentIngredients, DocumentCombiner, Exporter
...
class TestExporterModule(unittest.TestCase):
    ...
    @patch('mpvqc.io.doc_exporter.get_settings', return_value=MockedSettings(export_write_video_path=False))
    ...
    @patch('mpvqc.io.doc_exporter.get_settings', return_value=MockedSettings(export_nickname='mock-patch'))
    @patch('mpvqc.io.doc_exporter.get_metadata', return_value=MockedMetadata(app_name='mpvKuZeh'))
    ...
    @patch('mpvqc.io.doc_exporter.get_settings', return_value=MockedSettings())
    @patch('mpvqc.io.doc_exporter.get_metadata', return_value=MockedMetadata())
    @patch('mpvqc.io.doc_exporter.Path.write_text')
    ...
    @patch('mpvqc.io.doc_exporter.get_settings', return_value=MockedSettings())
    @patch('mpvqc.io.doc_exporter.get_metadata', return_value=MockedMetadata())
    @patch('mpvqc.io.doc_exporter.get_files', return_value=MockedFiles())
    @patch('mpvqc.io.doc_exporter.ZipFile')
