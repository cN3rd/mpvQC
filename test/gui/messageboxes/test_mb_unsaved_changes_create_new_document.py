...
from mpvqc.gui.messageboxes import UnsavedChangesCreateNewDocumentMessageBox, UnsavedChangesCreateNewDocumentResponse


class TestUnsavedChangesCreateNewDocumentMessageBox(unittest.TestCase):

    @patch('mpvqc.gui.messageboxes.mb_unsaved_changes_create_new_document.QMessageBox')
