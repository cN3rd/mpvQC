...
from mpvqc.gui.messageboxes.impls import ValidVideoFileFoundMessageBox, ValidVideoFileFoundResponse


class TestValidVideoFileFoundMessageBox(unittest.TestCase):

    @patch('mpvqc.gui.messageboxes.impls.mb_valid_video_file_found.QMessageBox')
