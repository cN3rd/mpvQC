...
from mpvqc.gui.messageboxes.impls import UnsavedChangesQuitMessageBox, UnsavedChangesQuitResponse


class TestUnsavedChangesQuitMessageBox(unittest.TestCase):

    @patch('mpvqc.gui.messageboxes.impls.mb_unsaved_changes_quit.QMessageBox')
