...
from mpvqc.gui.messageboxes.impls import ExistingCommentsDuringImportMessageBox, ExistingCommentsDuringImportResponse


class TestExistingCommentsDuringImportMessageBox(unittest.TestCase):

    @patch('mpvqc.gui.messageboxes.impls.mb_existing_comments_during_import.QMessageBox')
