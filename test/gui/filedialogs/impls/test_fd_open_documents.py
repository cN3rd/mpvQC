...
from mpvqc.gui.filedialogs.impls import OpenDocumentsDialog
...
class TestDocumentsDialog(unittest.TestCase):
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_documents.QWidget')
    @patch('mpvqc.gui.filedialogs.impls.fd_open_documents.QFileDialog.getOpenFileNames')
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_documents.QFileDialog.getOpenFileNames')
    def test_open_directory_home_by_default(self, mocked_get_open_file_names: Mock):
        dialog = OpenDocumentsDialog(parent=None)
        dialog.open(last_directory=None)
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_documents.QFileDialog.getOpenFileNames')
    def test_open_file_filters_txt(self, mocked_get_open_file_names: Mock):
        dialog = OpenDocumentsDialog(parent=None)
        dialog.open(last_directory=None)
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_documents.QFileDialog.getOpenFileNames', return_value=([], ''))
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_documents.QFileDialog.getOpenFileNames', return_value=(['/home/mpvqc/yep.txt'], ''))
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_documents.QFileDialog.getOpenFileNames', return_value=(['/home', '/another-home'], ''))
