...
from mpvqc.gui.filedialogs.impls import OpenNetworkStreamDialog


class TestNetworkStreamDialog(unittest.TestCase):

    @patch('mpvqc.gui.filedialogs.impls.fd_open_network_stream.QInputDialog')
    @patch('mpvqc.gui.filedialogs.impls.fd_open_network_stream.QWidget')
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_network_stream.QInputDialog.TextInput')
    @patch('mpvqc.gui.filedialogs.impls.fd_open_network_stream.QInputDialog')
