...
class TestSaveDialog(unittest.TestCase):
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_save.QWidget')
    @patch('mpvqc.gui.filedialogs.impls.fd_save.QFileDialog.getSaveFileName')
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_save.QFileDialog.getSaveFileName', return_value=('', ''))
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_save.QFileDialog.getSaveFileName', return_value=('/home/mpvqc/yep.txt', ''))
