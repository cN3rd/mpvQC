...
from mpvqc.gui.filedialogs.impls import OpenSubtitlesDialog
...
class TestSubtitlesDialog(unittest.TestCase):
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_subtitles.QWidget')
    @patch('mpvqc.gui.filedialogs.impls.fd_open_subtitles.QFileDialog.getOpenFileNames')
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_subtitles.QFileDialog.getOpenFileNames', return_value=([], ''))
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_subtitles.QFileDialog.getOpenFileNames', return_value=(['/home/mpvqc/yep.txt'], ''))
    ...
    @patch('mpvqc.gui.filedialogs.impls.fd_open_subtitles.QFileDialog.getOpenFileNames', return_value=(['/home', '/another-home'], ''))
