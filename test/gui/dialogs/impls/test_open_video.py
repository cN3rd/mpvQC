...
from mpvqc.gui.dialogs.impls import OpenVideoDialog
...
class TestVideoDialog(unittest.TestCase):
    ...
    @patch('mpvqc.gui.dialogs.impls.open_video.QWidget')
    @patch('mpvqc.gui.dialogs.impls.open_video.QFileDialog.getOpenFileName')
    ...
    @patch('mpvqc.gui.dialogs.impls.open_video.QFileDialog.getOpenFileName', return_value=('', ''))
    ...
    @patch('mpvqc.gui.dialogs.impls.open_video.QFileDialog.getOpenFileName', return_value=(['/home/mpvqc/yep.mp4'], ''))
