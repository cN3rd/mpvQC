...
from mpvqc.gui.dialogs.impls import OpenDocumentsDialog
...
class TestDocumentsDialog(unittest.TestCase):
    ...
    @patch('mpvqc.gui.dialogs.impls.open_documents.QFileDialog.getOpenFileNames')
    ...
    @patch('mpvqc.gui.dialogs.impls.open_documents.QFileDialog.getOpenFileNames', return_value=([], ''))
    ...
    @patch('mpvqc.gui.dialogs.impls.open_documents.QFileDialog.getOpenFileNames', return_value=(['/home/mpvqc/yep.txt'], ''))
    ...
    @patch('mpvqc.gui.dialogs.impls.open_documents.QFileDialog.getOpenFileNames', return_value=(['/home', '/another-home'], ''))
