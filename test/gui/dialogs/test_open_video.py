...
class TestVideoDialog(unittest.TestCase):
    ...
    @patch('mpvqc.gui.dialogs.open_video.QFileDialog.getOpenFileName')
    def test_open_passed_in_directory(self, mocked_get_open_file_names):
        dialog = OpenVideoDialog(parent=None)
    ...
    @patch('mpvqc.gui.dialogs.open_video.QFileDialog.getOpenFileName')
    def test_open_home_by_default(self, mocked_get_open_file_names):
        dialog = OpenVideoDialog(parent=None)
        dialog.open(last_directory=None)
    ...
    @patch('mpvqc.gui.dialogs.open_video.QFileDialog.getOpenFileName')
    def test_open_file_filters_video(self, mocked_get_open_file_names):
        dialog = OpenVideoDialog(parent=None)
        dialog.open(last_directory=None)
