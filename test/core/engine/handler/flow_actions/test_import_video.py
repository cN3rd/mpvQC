...
from mpvqc.core.engine.handler.flow_actions import VideoImportFlowActions
from mpvqc.core.engine.interface import Options
from test.doc_io.input import ANY_VIDEO
from test.core.engine import DEFAULT_OPTIONS, AppTestImpl, PlayerTestImpl, TableTestImpl


class TestSubtitleImportFlowActions(unittest.TestCase):
    GET_VIDEO = 'mpvqc.core.engine.handler.flow_actions.import_video.VideoImportDialog.get_video'
    PATH_IS_FILE = 'mpvqc.core.engine.handler.flow_actions.import_video.Path.is_file'

    MB_FOUND_VIDEO_ASK = 'mpvqc.core.engine.handler.flow_actions.import_video.VideoFoundMessageBox.ask'
    MB_FOUND_VIDEO_OPEN = 'mpvqc.core.engine.handler.flow_actions.import_video.VideoFoundMessageBox.do_we_open'

    LOAD = 'mpvqc.core.engine.handler.flow_actions.import_video.VideoImporter.load'
