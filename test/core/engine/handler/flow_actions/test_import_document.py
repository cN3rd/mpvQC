...
from mpvqc.core.engine.handler.flow_actions import DocumentImportFlowActions
...
class TestDocumentImportFlowActions(unittest.TestCase):
    GET_DOCUMENTS = 'mpvqc.core.engine.handler.flow_actions.import_document.DocumentImportDialog.get_documents'

    IMPORTER_IMPORT_THEM = 'mpvqc.core.engine.handler.flow_actions.import_document.Importer.import_them'
    IMPORTER_GET_IMPORT = 'mpvqc.core.engine.handler.flow_actions.import_document.Importer.get_import'

    MB_EXISTING_COMMENTS_ASK = 'mpvqc.core.engine.handler.flow_actions.import_document.ExistingCommentsMessageBox.ask'
    MB_EXISTING_COMMENTS_ABORT \
        = 'mpvqc.core.engine.handler.flow_actions.import_document.ExistingCommentsMessageBox.do_we_abort'
    MB_EXISTING_COMMENTS_CLEAR \
        = 'mpvqc.core.engine.handler.flow_actions.import_document.ExistingCommentsMessageBox.do_we_clear_table'

    TABLE_CLEARER_CLEAR = 'mpvqc.core.engine.handler.flow_actions.import_document.TableClearer.clear_table'

    COMMENTS_IMPORTER_LOAD = 'mpvqc.core.engine.handler.flow_actions.import_document.CommentsImporter.load'

    INCOMPATIBLES_SHOW = 'mpvqc.core.engine.handler.flow_actions.import_document.IncompatibleDocumentsMessageBox.show'
    ...
    def test_video_from_document_existing(self, *_):
        we = DocumentImportFlowActions(DEFAULT_OPTIONS, ANY_PATHS)
    ...
    def test_have_paths(self):
        we = DocumentImportFlowActions(DEFAULT_OPTIONS, tuple())
