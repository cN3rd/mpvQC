...
from mpvqc.core.engine.handler.flow_actions import NewDocumentFlowActions
from test.core.engine import DEFAULT_OPTIONS


class TestSubtitleImportFlowActions(unittest.TestCase):
    MB_CREATE_NEW_ASK = 'mpvqc.core.engine.handler.flow_actions.new_document.NewDocumentMessageBox.ask'
    MB_CREATE_NEW_DO_WE = 'mpvqc.core.engine.handler.flow_actions.new_document.NewDocumentMessageBox.do_we_create_new'

    CLEAR = 'mpvqc.core.engine.handler.flow_actions.new_document.TableClearer.clear_table'
