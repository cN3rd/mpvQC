...
from mpvqc.core.engine.handler.flow_actions import SaveDocumentFlowActions
from mpvqc.core.engine.interface import Options
from test.doc_io.input import ANY_PATH
from test.core.engine import DEFAULT_OPTIONS, PlayerTestImpl, AppTestImpl, TableTestImpl


class TestSubtitleImportFlowActions(unittest.TestCase):
    DIALOG_ASK = 'mpvqc.core.engine.handler.flow_actions.save_document.SaveDialog.get_write_path'
    MB_SHOW_ERROR = 'mpvqc.core.engine.handler.flow_actions.save_document.SaveErrorMessageBox.show'

    WRITE = 'mpvqc.core.engine.handler.flow_actions.save_document.DocumentExporter.export'
