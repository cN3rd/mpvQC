...
class TestSubtitleImportFlowActions(unittest.TestCase):
    GET_SUBTITLES = 'mpvqc.core.engine.handler.flow_actions.import_subtitles.SubtitleImportDialog.get_subtitles'
    LOAD = 'mpvqc.core.engine.handler.flow_actions.import_subtitles.SubtitleImporter.load'
