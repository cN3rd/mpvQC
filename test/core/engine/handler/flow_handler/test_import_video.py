...
from mpvqc.core.engine.handler.flow_handler import VideoImportFlowHandler
from test.doc_io.input import ANY_VIDEO
from test.core.engine import DEFAULT_OPTIONS


class Test(unittest.TestCase):
    FLOW_ACTIONS = 'mpvqc.core.engine.handler.flow_handler.import_video.VideoImportFlowActions'
