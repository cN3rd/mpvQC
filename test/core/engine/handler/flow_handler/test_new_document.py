...
from mpvqc.core.engine.handler.flow_handler import NewDocumentFlowHandler
from test.core.engine import DEFAULT_OPTIONS


class Test(unittest.TestCase):
    FLOW_ACTIONS = 'mpvqc.core.engine.handler.flow_handler.new_document.NewDocumentFlowActions'
