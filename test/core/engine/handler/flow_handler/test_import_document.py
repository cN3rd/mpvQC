...
from mpvqc.core.engine.handler.flow_handler import DocumentImportFlowHandler
from test.doc_io.input import ANY_PATHS, ANY_VIDEO, ANY_PATH
from test.core.engine import DEFAULT_OPTIONS


class Test(unittest.TestCase):
    DOC_FLOW_ACTIONS = 'mpvqc.core.engine.handler.flow_handler.import_document.DocumentImportFlowActions'
    VID_FLOW_ACTIONS = 'mpvqc.core.engine.handler.flow_handler.import_document.VideoImportFlowActions'
